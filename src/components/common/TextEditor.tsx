import { nextTick, VNode } from 'vue/types/umd'
...
export default class TextEditor extends Vue {
    ...
    render(): VNode {
        return (<div class={{ 'editor bg-gray-700 appearance-none relative block w-full px-3 py-2 placeholder-gray-500 outline-none text-gray-400 border border-transparent rounded-md sm:text-sm resize-none': true, 'border-red-700 placeholder-red-700 text-red-700': this.invalid }}>
            <div class="editor-button flex items-center leading-none space-x-3 mb-3">
                ...
                <div class="btn-holder p-1 space-x-2 border border-dashed border-gray-400 rounded-md">
